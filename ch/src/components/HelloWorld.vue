  ...
  <div class="">
    <v-card class="  ml-3 mt-3 mr-3 mb-3 elevation-5">
      <div class=" ml-4 mt-4d-flex d-flex flex-column justify-center">
        ...
        <div class="text-h3 d-flex justify-center mt-16 mb-3">About the ingredients</div>
        <div :style="{'z-index': '0'}" class="justify-center d-flex"><v-card  class="d-flex align-center elevation-20 justify-center  flex-wrap rounded-xl pt-3 pb-3" :style="{ 'max-width': '1100px' }">        
          ...
          <v-card-title class="pt-6 pl-10 pr-10">Charcoal</v-card-title>
        ...
        <div class=" d-flex justify-center mr-2 mt-2 ml-2 mb-2"><v-card class="rounded-xl elevation-1" :style="{ 'max-width': '500px' }" variant="tonal" >
          <v-card-title class="pt-6 pl-10 pr-10 ">Sulfur</v-card-title>
          <v-card-text>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente, odit facere inventore suscipit quae rerum? Debitis placeat exercitationem, atque vero magnam sit dolor quia libero quasi corrupti, porro inventore itaque.</v-card-text>
        </v-card></div>
        <div class=" d-flex justify-center mr-2 mt-2 ml-2 mb-2"><v-card class="rounded-xl elevation-1" :style="{ 'max-width': '500px' }" variant="tonal" >
          <v-card-title class="pt-6 pl-10 pr-10 ">Salpeter (KNO3)</v-card-title>
          <v-card-text>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente, odit facere inventore suscipit quae rerum? Debitis placeat exercitationem, atque vero magnam sit dolor quia libero quasi corrupti, porro inventore itaque.</v-card-text>
        </v-card></div>
      </v-card></div>

      <div class="text-h3 mt-16 d-flex justify-center mb-3">Tutorial</div>
      <div :style="{'z-index': '0'}" class="justify-center d-flex"><v-card  class="d-flex align-center elevation-20 justify-center  flex-wrap rounded-xl pt-3 pb-3" :style="{ 'max-width': '1100px' }">        
          <div class=" d-flex justify-center mr-2 mt-2 ml-2 mb-2"><v-card class="rounded-xl elevation-1" :style="{ 'max-width': '500px' }" variant="tonal" >
